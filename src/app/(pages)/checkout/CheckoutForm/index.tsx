      ...
      try {
        ...
        if (paymentIntent) {
          ...
          try {
            ...
            if (!orderReq.ok) throw new Error(orderReq.statusText || 'خطایی رخ داده است')
        ...
        const msg = err instanceof Error ? err.message : 'خطایی رخ داده است'
  ...
  return (
    <form onSubmit={handleSubmit} className={classes.form}>
      ...
      <div className={classes.actions}>
        ...
        <Button
          label={isLoading ? 'Loading...' : 'پرداخت'}
          type="submit"
          appearance="primary"
